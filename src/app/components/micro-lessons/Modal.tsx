...
const Modal: React.FC = () => {
    ...
    const { day, theme, notification, microLearning, tryThis, grounding, reflectionPrompt, socialHook } = modalData[modalDay - 1];
        ...
        <S.Modal active={isModal}>
            <S.ModalContainer>
                <S.ModalContent ref={modalRef}>
                    ...
                    <S.CompleteButton onClick={closeButton}>{loading ? 'Saving' : 'Complete Day'}</S.CompleteButton>
                </S.ModalContent>
            </S.ModalContainer>
